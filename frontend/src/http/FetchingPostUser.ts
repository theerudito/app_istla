...
import type {ApiResponse, ApiResponseAcciones} from "../models/ApiResponse.ts";
...
export const DELETE_UserPost = async (id: number): Promise<{ success: true; data: ApiResponseAcciones }> => {
    try {
